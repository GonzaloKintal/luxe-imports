                            ...
                            <li key={p._id || p.id} className="bg-white p-4 rounded-xl border border-gray-300 shadow-md flex items-center gap-4 transition-all duration-300 hover:shadow-lg">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <span className="text-gray-700 font-semibold">USD ${typeof p.price === 'number' ? p.price.toLocaleString('en-US', { minimumFractionDigits: 2 }) : 'N/A'}</span>
                                        <span className="text-gray-600 text-sm">
                                            {loadingCotizacion
                                                ...
                                                : errorCotizacion
                                                    ? errorCotizacion
                                                    : cotizacion
                                                        ? `AR$ ${(p.price * cotizacion).toLocaleString('es-AR', { minimumFractionDigits: 2 })}`
                                                        : 'Sin cotización'}
                                        </span>
                                    </div>
