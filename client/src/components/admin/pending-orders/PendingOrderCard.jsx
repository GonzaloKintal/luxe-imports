                    ...
                    <div className="mt-4 border-t border-gray-200 pt-4">
                        <div className="space-y-3">
                            {order.products.map((p, idx) => {
                                ...
                                return (
                                    <div key={prod._id || prod.id || idx} className="flex flex-col md:flex-row justify-between items-center py-3 px-4 bg-white rounded-lg border border-gray-100">
                                        <div className="flex-1 font-medium text-gray-900">{prod.title || prod.name || prod._id || 'Producto'}</div>
