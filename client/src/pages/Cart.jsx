                ...
                <>
                    <ul className="space-y-6 max-w-3xl mx-auto">
                        {products.map((p) => (
                            <li
                                key={p._id}
                                className="animate-fadeInDown bg-white border border-gray-300 p-4 rounded shadow flex flex-col sm:flex-row items-center gap-4 justify-between"
                            >
                                <img
            ...
            <div className="animate-fadeInDown mt-10 text-center max-w-3xl mx-auto">
                {!historialVisible ? (
                    ...
                    <>
                        ...
                        <h2 className="animate-fadeInDown text-xl font-semibold mt-4 mb-4 text-black">Historial de Compras</h2>
                        {historialCarritos.length ? (
                                        ...
                                        >
                                            <div className="flex justify-between items-center">
                                                <div>
                                                    ...
                                                    {carrito.paidAt && (
                                                        <p className="text-sm text-gray-600">Pagado: {new Date(carrito.paidAt).toLocaleString()}</p>
                                                    )}
                                                </div>
                                                <button
                            ...
                            <p className="text-gray-600">No hay compras anteriores.</p>
                        )}
                    </>
                )}
            </div>
